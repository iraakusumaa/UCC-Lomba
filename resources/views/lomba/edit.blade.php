...
<form action="/lomba/{{$lomba->id}}/edit" method="post">
  ...
  <div class="form-group">
    ...
    <input name="poster"type="text" class="form-control" id="poster" placeholder="Masukkan Url Poster" value= "{{$lomba->poster}}" required>
  </div>
  <div class="form-group">
    <label for="tanggal">Tanggal penutupan</label>
